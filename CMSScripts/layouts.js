...
function GetLeftButton() {
    var s = navigator.userAgent.toLowerCase() + '';
    if ((s.indexOf('gecko/') >= 0) || (s.indexOf('opera/') >= 0) || (parseInt(s.match(/msie (\d+)/)[1], 10) == 9)) {
        return 0;
    }
    else {
        return 1;
...
function EnsureOverlay(cursor, el) {
    ...
    layoutOverlayElem.style.top = document.documentElement.scrollTop + 'px';
    layoutOverlayElem.style.left = document.documentElement.scrollLeft + 'px';
