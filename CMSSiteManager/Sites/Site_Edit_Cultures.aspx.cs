...
public partial class CMSSiteManager_Sites_Site_Edit_Cultures : SiteManagerPage
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (si != null)
        {
            bool multilingual = LicenseHelper.CheckFeature(si.DomainName, FeatureEnum.Multilingual);
            ...
            else
            {
                ...
                {
                    LicenseHelper.CheckFeatureAndRedirect(si.DomainName, FeatureEnum.Multilingual);
                }
            }
