...
public partial class CMSAdminControls_UI_UniGrid_Controls_AdvancedExport : CMSUserControl, IPostBackEventHandler
{
    ...
    private static string VALIDATE_EXPORT_PREFIX = "ValidateExport_";

    private static string DEFAULT_SELECTION_PREFIX = "DefaultSelection_";

    private static string FIX_DIALOG_HEIGHT_PREFIX = "FixDialogHeight_";

    private static string SET_CHECKED_PREFIX = "SetChecked";
    ...
    private UniGridExportHelper UniGridExportHelper
    {
        get
        {
            if (mUniGridExportHelper == null)
            {
                ...
                mUniGridExportHelper.Error += new DataExportHelper.OnError(mUniGridExportHelper_Error);
