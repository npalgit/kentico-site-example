...
public partial class CMSModules_CustomTables_Tools_CustomTable_List : CMSCustomTablesToolsPage
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        uniGrid.WhereCondition = SqlHelperClass.AddWhereCondition("ClassIsCustomTable = 1", "ClassID IN (SELECT ClassID FROM CMS_ClassSite WHERE SiteID = " + CMSContext.CurrentSite.SiteID + ")");
    }
