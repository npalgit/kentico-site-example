...
public partial class CMSModules_MessageBoards_Controls_MessageBoard : CMSUserControl
{
    ...
    void boardMsgActions_OnMessageAction(string actionName, object argument)
    {
        ...
        BoardMessageInfo bmi = null;

        switch (actionName.ToLower())
        {
            case "delete":
                // Delete message
                BoardMessageInfoProvider.DeleteBoardMessageInfo(boardMessageId);
            ...
            case "approve":
                ...
                bmi = BoardMessageInfoProvider.GetBoardMessageInfo(boardMessageId);
                if ((bmi != null) && (CMSContext.CurrentUser != null))
                {
                    bmi.MessageApprovedByUserID = CMSContext.CurrentUser.UserID;
                    bmi.MessageApproved = true;
                    BoardMessageInfoProvider.SetBoardMessageInfo(bmi);
                }
            ...
            case "reject":
                ...
                if ((bmi != null) && (CMSContext.CurrentUser != null))
                {
                    bmi.MessageApprovedByUserID = 0;
                    bmi.MessageApproved = false;
                    BoardMessageInfoProvider.SetBoardMessageInfo(bmi);
                }
        ...
        else
        {
            ...
            if (bi != null)
            {
                ...
                if (bi.BoardEnabled)
                {
                    ...
                    if (BoardInfoProvider.IsUserAuthorizedToAddMessages(bi))
                    {
