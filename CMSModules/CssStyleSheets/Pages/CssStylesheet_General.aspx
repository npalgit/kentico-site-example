                ...
                <tr>
                    ...
                    <td>
                        <cms:MacroEditor ID="txtCssStylesheetText" runat="server" EnableViewState="false"
                            Editor-EditorMode="Advanced" Editor-Language="CSS" Editor-ShowBookmarks="true" Editor-Width="620px" Editor-Height="385px"
                            Editor-RegularExpression="\s*/\*\s*#\s*([a-zA-Z_0-9-/\+\*.=~\!@\$%\^&\(\[\]\);:<>\?\s]*)\s*#\s*\*/"
                            Editor-EnablePositionMember="true" Editor-EnableSections="true" />
                        <cms:ExtendedListBox ID="extListBox" runat="server" TextBoxControl="txtCssStylesheetText"
                            SectionSeparator="/" Width="250px" Height="390px" />
                    </td>
                </tr>
            </tbody>
        </table>
