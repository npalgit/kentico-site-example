...
public partial class CMSModules_CssStylesheets_Pages_CssStylesheet_General : CMSModalPage
{
    ...
    protected override void OnPreInit(EventArgs e)
    {
        ...
        {
            // Check hash
            if (!QueryHelper.ValidateHash("hash", "saved;cssstylesheetid;selectorid;tabmode"))
            {
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        // If syntax highlighter is enabled, remove listbox with bookmarks (sections)
        if (txtCssStylesheetText.SyntaxHighlightingEnabled)
        {
            extListBox.Parent.Controls.Remove(extListBox);
        }
    ...
    private void SetDialogMode(CssStylesheetInfo si)
    {
        ...
        string where = SqlHelperClass.AddWhereCondition("SiteID = " + CMSContext.CurrentSiteID, "StylesheetID = " + si.StylesheetID);
