...
<table>
    ...
    <tr>
        ...
        <td class="FieldValue">
            <asp:HyperLink ID="lnkUrlValue" runat="server" />
        </td>
    </tr>
    <tr>
        <td class="FieldLabel">
        ...
        <td class="FieldValue">
            <asp:Label ID="lblCultureValue" runat="server" />
        </td>
    </tr>
    <tr>
        <td class="FieldLabel">
        ...
        <td class="FieldValue">
            <cms:LocalizedLabel ID="lblObjectTypeValue" runat="server" />
        </td>
    </tr>
    <tr>
        <td class="FieldLabel">
        ...
        <td class="FieldValue">
            <cms:LocalizedLabel ID="lblObjectNameValue" runat="server" />
        </td>
    </tr>
    <tr>
        <td class="FieldLabel">
        ...
        <td class="FieldValue">
            <cms:LocalizedLabel ID="lblReportedByValue" runat="server" />
        </td>
    </tr>
    <tr>
        <td class="FieldLabel">
        ...
        <td class="FieldValue">
            <cms:LocalizedLabel ID="lblReportedWhenValue" runat="server" />
        </td>
    </tr>
    <tr>
        <td class="FieldLabel">
        ...
        <td class="FieldValue">
            <asp:Label ID="lblSiteValue" runat="server" />
        </td>
    </tr>
    <tr>
        <td class="FieldLabel">
        ...
        <tr>
            ...
            <td class="FieldLabelHigh">
                <cms:LocalizedHyperlink ID="lnkShowDetails" runat="server" ResourceString="abuse.details"
                    NavigateUrl="AbuseReport_Edit.aspx" Target="_blank" Visible="false" />
            </td>
        </tr>
        <tr>
