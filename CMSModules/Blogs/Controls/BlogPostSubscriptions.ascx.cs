...
public partial class CMSModules_Blogs_Controls_BlogPostSubscriptions : CMSAdminControl
{
    ...
    {
        return BlogPostSubscriptionInfoProvider.GetBlogPostSubscriptions(this.UserID, this.SiteID, completeWhere, currentTopN, currentOrder, "SubscriptionID, SubscriptionEmail, DocumentName, NodeAliasPath, DocumentCulture", currentOffset, currentPageSize, ref totalRecords);
    }
