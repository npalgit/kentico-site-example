<%@ Page Language="C#" MasterPageFile="~/CMSMasterPages/UI/SimplePage.master" AutoEventWireup="true" Inherits="CMSModules_Blogs_Tools_Blogs_Blogs_List"
    Title="Blogs - Blogs list" Theme="Default" CodeFile="Blogs_Blogs_List.aspx.cs" %>
...
<asp:Content ContentPlaceHolderID="plcContent" runat="Server">
    <cms:UniGrid ID="gridBlogs" runat="server" GridName="Blog_List.xml" IsLiveSite="false" />
