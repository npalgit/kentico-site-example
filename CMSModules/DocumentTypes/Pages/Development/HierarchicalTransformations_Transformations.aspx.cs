...
[EditedObject("cms.transformation", "transid", "HierarchicalTransformations_Frameset.aspx")]
...
public partial class CMSModules_DocumentTypes_Pages_Development_HierarchicalTransformations_Transformations : CMSModalDesignPage
{
    ...
    protected override void OnPreInit(EventArgs e)
    {
        ...
        if (mDialogMode)
        {
            ...
            if (!TabMode)
            {
                CurrentMaster.Title.TitleText = GetString("transformationedit.title");
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!RequestHelper.IsPostBack())
        {
            ...
            drpTransformations.Items.Add(new ListItem(GetString("hiertransf.headeritem"), "header"));
            drpTransformations.Items.Add(new ListItem(GetString("hiertransf.footeritem"), "footer"));
