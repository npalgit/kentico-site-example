    ...
    protected void ucTransf_OnSaved(object sender, EventArgs e)
    {
        ...
        else
        {
            ...
            if (!string.IsNullOrEmpty(selector))
            {
                ...
                script += " window.name='hierarchicalproperties';  window.open('" + ResolveUrl("~/CMSModules/DocumentTypes/Pages/Development/HierarchicalTransformations_Transformations.aspx") + "?transID=" + ucTransf.TransInfo.TransformationID + "&classid=" + ucTransf.DocumentTypeID + "&editonlycode=true','hierarchicalproperties')";
