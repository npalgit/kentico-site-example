...
public partial class CMSModules_DocumentTypes_Controls_HierarchicalTransformations_Edit : CMSAdminEditControl
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        ucClassSelector.UniSelector.SelectionMode = SelectionModeEnum.SingleTextBox;
        ...
        {
            drpTemplateType.Items.Add(new ListItem(GetString("Item transformation"), "item"));
            drpTemplateType.Items.Add(new ListItem(GetString("Alternating item transformation"), "alternatingitem"));
            drpTemplateType.Items.Add(new ListItem(GetString("First item transformation"), "firstitem"));
            drpTemplateType.Items.Add(new ListItem(GetString("Last item transformation"), "lastitem"));
            drpTemplateType.Items.Add(new ListItem(GetString("Header item transformation"), "header"));
            drpTemplateType.Items.Add(new ListItem(GetString("Footer item transformation"), "footer"));
            drpTemplateType.Items.Add(new ListItem(GetString("Single item transformation"), "singleitem"));
            drpTemplateType.Items.Add(new ListItem(GetString("Separator transformation"), "separator"));
            drpTemplateType.Items.Add(new ListItem(GetString("Current item transformation"), "currentitem"));
