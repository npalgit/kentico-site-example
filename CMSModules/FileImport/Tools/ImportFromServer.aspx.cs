...
public partial class CMSModules_FileImport_Tools_ImportFromServer : CMSFileImportPage
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        {
            imgAzurePrepare.ImageUrl = ResolveUrl(GetImageUrl("CMSModules/CMS_Content/Dialogs/importprepare.png"));
            lnkAzurePrepare.Text = GetString("dialogs.mediaview.azureprepare");
    ...
    protected void lnkAzurePrepare_Click(object sender, EventArgs e)
    {
    ...
    private void LogExceptionToEventLog(Exception ex)
    {
        ...
        log.LogEvent(EventLogProvider.EVENT_TYPE_ERROR, DateTime.Now, "Content", "IMPORTFILE", CMSContext.CurrentUser.UserID, CMSContext.CurrentUser.UserName, 0, null, HTTPHelper.GetUserHostAddress(), EventLogProvider.GetExceptionLogMessage(ex), CMSContext.CurrentSiteID, HTTPHelper.GetAbsoluteUri());
