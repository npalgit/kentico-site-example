...
<asp:Panel ID="pnlMvtCombination" runat="server" CssClass="MVTCombinationPanel">
    <div class="FloatLeft">
        <cms:LocalizedLabel ID="lblCombination" runat="server" AssociatedControlID="" ResourceString="mvtcombination.name"
    ...
    <asp:PlaceHolder ID="plcEditCombination" runat="server">
        <div class="FloatLeft">
            <cms:LocalizedCheckBox ID="chkEnabled" runat="server" ResourceString="general.enabled"
                CssClass="MVTCombinationEnabled" />
        </div>
        <div class="FloatLeft">
            <cms:LocalizedLabel ID="lblCustomName" runat="server" ResourceString="mvtcombination.customName"
        ...
        <div class="FloatLeft">
            <cms:LocalizedButton ID="btnChange" runat="server" ResourceString="general.change"
                CssClass="MVTCombinationButton" />
        </div>
        <div class="FloatLeft">
            <cms:LocalizedLabel ID="lblSaved" runat="server" ResourceString="mvtvariant.customnamesaved"></cms:LocalizedLabel>
        </div>
        <asp:PlaceHolder ID="plcUseCombination" runat="server" Visible="false">
            <div class="FloatRight">
                <cms:LocalizedButton ID="btnUseCombination" runat="server" ResourceString="mvt.usecombination"
                    CssClass="MVTCombinationButtonUse" />
            </div>
        </asp:PlaceHolder>
    </asp:PlaceHolder>
...
<asp:PlaceHolder ID="plcRunningTestWarning" runat="server" Visible="false">
    <div class="MVTCombinationPanelWarning">
        <cms:LocalizedLabel ID="lblWarning" runat="server" ResourceString="mvtest.runningtestwarning"></cms:LocalizedLabel>
    </div>
</asp:PlaceHolder>
