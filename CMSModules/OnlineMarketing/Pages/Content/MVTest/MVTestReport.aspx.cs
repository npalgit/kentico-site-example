...
public partial class CMSModules_OnlineMarketing_Pages_Content_MVTest_MVTestReport : CMSOnlineMarketingPage
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (pnlCombination.Visible)
        {
            ...
            string cultureWhere = " AND DocumentCulture = '" + CMSContext.CurrentUser.PreferredCultureCode.Replace("'", "''") + "'";
            string where = "MVTCombinationPageTemplateID IN ( SELECT DocumentPageTemplateID FROM View_CMS_Tree_Joined WHERE NodeSiteID = " + CMSContext.CurrentSiteID + @"
                                        AND NodeID = " + nodeID + " " + cultureWhere + ")";
        ...
        if (CMSContext.CurrentUser.IsAuthorizedPerResource("CMS.WebAnalytics", "ManageData"))
        {
            ...
            "?statcodename=mvtconversion;" + testName + ";%', 'AnalyticsManageData', 450, 260); return false; ";
    ...
    private void DisplayReport(bool reload)
    {
        ...
        String conversionCombinations = "mvtestconversionsbycombinations.yearreport;mvtestconversionsbycombinations.monthreport;mvtestconversionsbycombinations.weekreport;mvtestconversionsbycombinations.dayreport;mvtestconversionsbycombinations.hourreport&help=conversionsbycombinations";
