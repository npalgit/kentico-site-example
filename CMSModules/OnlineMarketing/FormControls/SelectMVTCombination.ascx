...
<cms:CMSUpdatePanel ID="pnlUpdate" runat="server" UpdateMode="Conditional">
    <ContentTemplate>
        <cms:UniSelector runat="server" ID="ucUniSelector" ObjectType="OM.MVTCombination" SelectionMode="SingleDropDownList"
            ResourcePrefix="selectmvtcombination" MaxDisplayedItems="1000"
            ReturnColumnName="MVTCombinationName" DisplayNameFormat="{%MVTCombinationCustomName%}" DefaultDisplayNameFormat="{%MVTCombinationName%}" OrderBy="MVTCombinationID" EmptyReplacement="" />
    </ContentTemplate>
</cms:CMSUpdatePanel>
