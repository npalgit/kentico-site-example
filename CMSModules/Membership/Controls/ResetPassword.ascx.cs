...
public partial class CMSModules_Membership_Controls_ResetPassword : CMSUserControl
{
    ...
    {        
        ...
        string invalidRequestMessage = DataHelper.GetNotEmpty(InvalidRequestText, String.Format(ResHelper.GetString("membership.passwresetfailed"), "~/cmspages/logon.aspx?forgottenpassword=1"));
        ...
        if (!URLHelper.IsPostback())
        {
            ...
            // Prepare messages
            string timeExceededMessage = DataHelper.GetNotEmpty(ExceededIntervalText, String.Format(ResHelper.GetString("membership.passwreqinterval"), "~/cmspages/logon.aspx?forgottenpassword=1"));
