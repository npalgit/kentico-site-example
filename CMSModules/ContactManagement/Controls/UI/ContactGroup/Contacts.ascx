        ...
        <ContentTemplate>
            <cms:UniGrid runat="server" ID="gridElem" OrderBy="ContactLastName" ObjectType="om.contactgroupcontactlist" ShowObjectMenu="false"
                ...
                <GridColumns>
                    ...
                    <ug:Column Source="ContactStatusID" ExternalSourceName="#contactstatusname" Caption="$om.contactstatus$" Wrap="false">
                        <Filter Type="text" Size="100" />
                    </ug:Column>
                    <ug:Column Source="ContactCountryID" ExternalSourceName="#countryname" Caption="$objecttype.cms_country$" Wrap="false">
                        <Filter Type="text" Size="100" />
                    </ug:Column>
                    <ug:Column Source="ContactSiteID" Caption="$general.sitename$" ExternalSourceName="#sitenameorglobal" Name="SiteName" Wrap="false" />
