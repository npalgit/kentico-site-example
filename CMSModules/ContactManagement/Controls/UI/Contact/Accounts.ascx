        ...
        <ContentTemplate>
            <cms:UniGrid runat="server" ID="gridElem" ShortID="g" OrderBy="AccountName" ObjectType="om.contactaccountlist"
                ...
                <GridColumns>
                    ...
                    <ug:Column Source="ContactRoleID" ExternalSourceName="#contactrolename" Caption="$om.contactrole$" Wrap="false">
                        <Filter Type="text" Size="100" />
                    </ug:Column>
                    <ug:Column Source="AccountStatusID" ExternalSourceName="#accountstatusname" Caption="$om.accountstatus.name$" Wrap="false">
                        <Filter Type="text" Size="100" />
                    </ug:Column>
                    <ug:Column Source="AccountCountryID" ExternalSourceName="#countryname" Caption="$objecttype.cms_country$" Wrap="false">
                        <Filter Type="text" Size="100" />
                    </ug:Column>
                    <ug:Column Width="100%" />
                </GridColumns>
