    ...
    <ContentTemplate>
        ...
        <cms:UniGrid runat="server" ID="gridElem" ObjectType="om.contactlist" OrderBy="ContactLastName"
            ...
            <GridColumns>
                ...
                <ug:Column Source="ContactCountryID" ExternalSourceName="#countryname" Caption="$general.country$" Wrap="false">
                </ug:Column>
                <ug:Column Source="ContactSiteID" Caption="$general.site$" Wrap="false" ExternalSourceName="#sitenameorglobal" Name="sitedisplayname">
                </ug:Column>
