...
public partial class CMSModules_ContactManagement_Controls_UI_Contact_MergeSplit : CMSAdminListControl, ICallbackEventHandler
{
    ...
    {
        bool isGlobal = this.Contact.ContactSiteID == 0;
        ...
        else if (isGlobal)
        {
            ...
            where = SqlHelperClass.AddWhereCondition(where, "ContactID IN (SELECT * FROM Func_OM_Contact_GetChildren_Global(" + this.Contact.ContactID + ", 0))");
        }
        else
        {
