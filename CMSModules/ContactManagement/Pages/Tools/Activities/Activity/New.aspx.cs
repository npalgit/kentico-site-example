...
public partial class CMSModules_ContactManagement_Pages_Tools_Activities_Activity_New : CMSContactManagementActivitiesPage
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        bool showSiteSelector = (siteId == UniSelector.US_ALL_RECORDS || siteId == UniSelector.US_GLOBAL_RECORD) && CMSContext.CurrentUser.UserSiteManagerAdmin;
        editElem.SiteID = siteId;
        editElem.ShowSiteSelector = showSiteSelector;
