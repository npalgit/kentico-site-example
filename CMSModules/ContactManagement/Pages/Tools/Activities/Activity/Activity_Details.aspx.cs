...
public partial class CMSModules_ContactManagement_Pages_Tools_Activities_Activity_Activity_Details : CMSModalPage
{
    ...
    void btnSave_Click(object sender, EventArgs e)
    {
        if (userIsAuthorized && (activityId > 0))
        {
            ...
            ai.ActivityTitle = TextHelper.LimitLength(txtTitle.Text, 250);
    ...
    protected void LoadData()
    {
        ...
        string dispName = ActivityTypeInfoProvider.GetActivityTypeDisplayName(ai.ActivityType);
        if (dispName == null) 
        {
            dispName = GetString("general.na");
        }
