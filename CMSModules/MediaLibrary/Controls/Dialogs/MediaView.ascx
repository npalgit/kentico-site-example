...
<div class="DialogViewContentTop">
    <table cellpadding="0" cellspacing="0" width="100%">
        <tr>
            ...
            <asp:PlaceHolder ID="plcAzure" runat="server" Visible="false">
                <td class="TextRight">
                    <asp:LinkButton ID="lnkAzurePrepare" runat="server" CssClass="MenuItemEditSmall" EnableViewState="false">
                        <asp:Image ID="imgAzurePrepare" runat="server" />
                        <span>
                            <% =mSaveText %>
                        </span>
                    </asp:LinkButton>
