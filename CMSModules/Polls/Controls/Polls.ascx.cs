...
public partial class CMSModules_Polls_Controls_Polls : CMSAdminEditControl
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        PollsList.IsLiveSite = this.IsLiveSite;
        PollEdit.IsLiveSite = this.IsLiveSite;
        PollNew.IsLiveSite = this.IsLiveSite;

        PollNew.SiteID = this.SiteID;
        PollEdit.SiteID = this.SiteID;

        // Set display mode
        PollNew.DisplayMode = this.DisplayMode;
        PollEdit.DisplayMode = this.DisplayMode;
        ...
        PollNew.GroupID = this.GroupID;
        PollNew.GroupGUID = this.GroupGUID;
