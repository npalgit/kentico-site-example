...
public partial class CMSModules_Polls_Controls_PollEdit : CMSAdminEditControl
{
    ...
    public int SiteID
    {
        ...
        {
            mSiteID = value;
            this.PollProperties.SiteID = mSiteID;
        }
    }
    ...
    public bool AnswerEditSelected
    {
        get
        {
            return ValidationHelper.GetBoolean(this.ViewState["answeredit"], false);
        }
        set
        {
            this.ViewState["answeredit"] = value;
        }
    }
    ...
    {
        PollProperties.IsLiveSite = this.IsLiveSite;
        AnswerList.IsLiveSite = this.IsLiveSite;
        AnswerEdit.IsLiveSite = this.IsLiveSite;
        PollSecurity.IsLiveSite = this.IsLiveSite;
        PollView.IsLiveSite = this.IsLiveSite;
    ...
    void DisplayControls(string selectedPage, bool forceReload)
    {
        ...
        switch (selectedPage)
        {
            ...
            default:
                ...
                PollProperties.DisplayMode = this.DisplayMode;
