                ...
                <asp:Panel runat="server" ID="pnlItem" CssClass="Item">
                    <asp:Panel runat="server" ID="pnlItemPadding" CssClass="ItemPadding">
                        <asp:Image runat="server" ID="imgItem" CssClass="IconBig" EnableViewState="false"
                            ImageUrl='<%# GetImageUrl("DocumentTypeIcons/" + Convert.ToString(DataBinder.Eval(Container.DataItem, "ClassName")).Replace(".", "_") + ".png") %>' />&nbsp;
                        <asp:Label runat="server" ID="lblItem" CssClass="Name" EnableViewState="false" Text='<%# DataBinder.Eval(Container.DataItem, "ClassDisplayName") %>' />
                    </asp:Panel>
                </asp:Panel>
            </ItemTemplate>
        </asp:Repeater>
