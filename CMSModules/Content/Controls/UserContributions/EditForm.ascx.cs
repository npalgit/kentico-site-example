                    ...
                    else
                    {
                        ...
                        else
                        {
                            ...
                            if (NewDocument)
                            {
                                ...
                                titleElem.TitleText = GetString("Content.NewTitle") + ": " + ci.ClassDisplayName;
            ...
            case "classdisplayname":
                {
                    ...
                    Label lbl = new Label();
                    lbl.Text = HTMLHelper.HTMLEncode(Convert.ToString(row["ClassDisplayName"]));
