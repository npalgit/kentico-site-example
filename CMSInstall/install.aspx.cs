...
public class InstallInfo
{
    ...
    public static UserInfo CurrentUser 
    {
        get
        {
            ...
            {
                mCurrentUser = UserInfoProvider.GetUserInfo("administrator");
            }
...
public partial class CMSInstall_install : CMSPage, ICallbackEventHandler
{
    ...
    public ImportManager ImportManager
    {
        get
        {
            ...
            {
                SiteImportSettings imSettings = new SiteImportSettings(CurrentUser);
    ...
    protected void Page_Load(Object sender, EventArgs e)
    {
        ...
        if (!RequestHelper.IsCallback())
        {
            ...
            lblVersion.Text = ResHelper.GetFileString("install.Version") + "&nbsp;" + CMSContext.GetFriendlySystemVersion(true);
