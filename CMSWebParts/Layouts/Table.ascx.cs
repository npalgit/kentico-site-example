...
public partial class CMSWebParts_Layouts_Table : CMSAbstractLayoutWebPart
{
    ...
    protected override void PrepareLayout()
    {
        ...
        // In design mode, add cell for the header
        if (IsDesign && AllowDesignMode)
        {
            ...
            if (IsDesign)
            {
                Append("<td class=\"BothResizer\">&nbsp;</td>");
            }
            ...
            for (int i = 1; i <= this.Columns; i++)
            {
                ...
                Append("<td class=\"VerticalResizer\">&nbsp;</td>");
                Append("<td class=\"BothResizer\" onmousedown=\"" + GetHorizontalResizerScript("cell_1_" + i, widthPropertyName) + " return false;\">&nbsp;</td>");
            }
        ...
        for (int j = 1; j <= this.Rows; j++)
        {
            ...
            if (IsDesign && AllowDesignMode)
            {
                Append("<td class=\"HorizontalResizer\">&nbsp;</td>");
            }
            ...
            if (IsDesign && AllowDesignMode)
            {
                ...
                if (IsDesign)
                {
                    Append("<td class=\"BothResizer\" onmousedown=\"" + GetVerticalResizerScript("cell_" + j + "_1", heightPropertyName) + " return false;\">&nbsp;</td>");
                }
