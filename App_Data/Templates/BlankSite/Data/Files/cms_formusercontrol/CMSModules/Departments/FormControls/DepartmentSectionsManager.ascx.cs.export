...
public partial class CMSModules_Departments_FormControls_DepartmentSectionsManager : FormEngineUserControl
{
    ...
    public void ProcessDepartment(object sender, EventArgs e)
    {
        ...
        if (sourceNode != null)
        {
            DocumentHelper.CopyNodeData(sourceNode, editedNode, true, true, false, true, true, false, false, "DocumentName;NodeAlias;DocumentTagGroupID;DocumentStylesheetID");
