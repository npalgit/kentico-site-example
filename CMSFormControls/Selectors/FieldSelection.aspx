<%@ Page Language="C#" AutoEventWireup="true" Inherits="CMSFormControls_Selectors_FieldSelection"
    Title="Field selection" ValidateRequest="false" Theme="default" MasterPageFile="~/CMSMasterPages/UI/Dialogs/ModalDialogPage.master" CodeFile="FieldSelection.aspx.cs" %>

<%@ Register Src="~/CMSFormControls/Classes/SelectClassNames.ascx" TagPrefix="cms" TagName="SelectClassNames" %>
            ...
            <asp:Panel ID="pnlContent" CssClass="PageContent" runat="server">
                ...
                <script type="text/javascript">
                    ...
                    function SelectFields(drpId) {
                        ...
                        if ((wopener != null) && (wopener.SetValue != null)) {
                            wopener.SetValue(value, text);
                        }
                        Close();
                    }
                    //]]>
